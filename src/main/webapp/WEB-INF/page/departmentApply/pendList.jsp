				...
				<table class="table table-hover  table-bordered table-striped" style="margin-bottom: 0px;">
					...
					<c:forEach var="apply" items="${applyList }" varStatus="status">
						<tr>
							...
							<td>${apply.statusName }</td>
							<td><button type="button" class="btn btn-primary btn-xs" onclick="javascript:window.location.href='${pageContext.request.contextPath}/departmentApply/detail?applyId=${apply.id}'">详情</button></td>
						</tr>
					</c:forEach>
